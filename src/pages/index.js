  ...
  return (
   ...
   >
        <Helmet>
            ...
            <meta property="og:description" content="The PluralityNET project — GPLv3+ artificial brains integrating various world consensuses systems, plus AGI, AI, and non-AI systems in the world, including deep learning, machine learning and Big Data systems." />
        </Helmet>
